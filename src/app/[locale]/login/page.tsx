...
function LoginContent() {
  ...
  return (
    <div
      className={`min-h-screen flex items-center justify-center p-4 transition-colors duration-200 ${isDark ? "bg-gray-950" : "bg-gray-50/50"}`}
    >
      <div className="w-full max-w-md">
        ...
        <div className="flex justify-end mb-3">
          <div className="relative" ref={languageMenuRef}>
            ...
            {showLanguageMenu && (
              <div
                className={`absolute right-0 top-full mt-1 w-32 rounded-xl shadow-lg border overflow-hidden z-50 ${isDark ? "bg-gray-800 border-gray-700" : "bg-white border-gray-200"}`}
              >
                <button
        ...
        {/* Main Card */}
        <div
          className={`rounded-2xl border shadow-sm pt-1 pb-5 px-5 sm:pb-8 sm:px-8 ${isDark ? "bg-gray-900 border-gray-800" : "bg-white border-gray-100"}`}
        >
          {/* Logo */}
          <div className="flex flex-col items-center mb-2 sm:mb-4 pt-2 sm:pt-4">
            ...
            />
            <h1
              className={`text-xl sm:text-2xl font-bold mt-2 ${isDark ? "text-white" : "text-gray-900"}`}
            >
              {t("LoginPage.welcome")}
            </h1>
          </div>
          ...
          {(isPending2FA || twoFAPending) && (
            <div
              className={`mb-4 p-3 rounded-xl border flex items-center space-x-2.5 ${isDark ? "bg-orange-900/20 border-orange-800/40" : "bg-orange-50 border-orange-200"}`}
            >
          ...
          {showVerificationMessage && (
            <div
              className={`mb-4 p-3 rounded-xl border ${isDark ? "bg-emerald-900/20 border-emerald-800/40" : "bg-emerald-50 border-emerald-200"}`}
            >
              <div className="flex items-start space-x-2.5">
                <CheckCircleIcon
                  className={`w-5 h-5 mt-0.5 flex-shrink-0 ${isDark ? "text-emerald-400" : "text-emerald-600"}`}
                />
                <div className="flex-1">
                  <h3
                    className={`text-sm font-semibold mb-1 ${isDark ? "text-emerald-200" : "text-emerald-800"}`}
                  >
                    {t("LoginPage.accountCreatedSuccessfully")}
                  </h3>
                  <p
                    className={`text-xs mb-2.5 ${isDark ? "text-emerald-300" : "text-emerald-700"}`}
                  >
          ...
          >
            ...
            <div>
              <label
                className={`block text-[11px] font-semibold uppercase tracking-wider mb-1.5 ${isDark ? "text-gray-500" : "text-gray-400"}`}
              >
                {t("LoginPage.email")}
              </label>
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                  <EnvelopeIcon
                    className={`h-4 w-4 sm:h-5 sm:w-5 ${isDark ? "text-gray-600" : "text-gray-400"}`}
                  />
                </div>
                <input
                  type="email"
            ...
            {resetMessage && (
              <div
                className={`p-2.5 rounded-xl ${isDark ? "bg-emerald-900/20 border border-emerald-800" : "bg-emerald-50 border border-emerald-200"}`}
              >
                <p
                  className={`text-[12px] text-center ${isDark ? "text-emerald-300" : "text-emerald-600"}`}
                >
                  {resetMessage}
                </p>
              </div>
          ...
          <div className="my-4 sm:my-5">
            <div className="relative">
              <div className="absolute inset-0 flex items-center">
                <div
                  className={`w-full border-t ${isDark ? "border-gray-800" : "border-gray-200"}`}
                />
              </div>
              <div className="relative flex justify-center text-xs">
                <span
                  className={`px-3 ${isDark ? "bg-gray-900 text-gray-600" : "bg-white text-gray-400"}`}
                >
                  {t("LoginPage.or")}
                </span>
              </div>
