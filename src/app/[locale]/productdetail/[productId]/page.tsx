...
const ProductDetailPage: React.FC<ProductDetailPageProps> = ({ params }) => {
  ...
  const isAddToCartDisabled = useMemo(() => {
    ...
    if (!product.sellerName || product.sellerName === "Unknown") {
      return true;
    }
  ...
  return (
    ...
    >
      ...
      <div
        className={`sticky sticky-below-market-header-mobile lg:top-[calc(3.25rem+1px)] xl:top-[calc(3.5rem+1px)] z-[60] border-b transition-all duration-300 ${
          isDarkMode
