    ...
    <div className={containerClasses} ref={searchContainerRef}>
      ...
      >
        ...
        <button
          ...
          `}
          aria-label={
            isSearching ? t("header.search") : t("header.startSearch")
          }
        >
          {isSubmitting ? (
          ...
          >
            ...
            {isFirestoreMode && (
              <div className={`px-3 pt-3 pb-1`}>
                ...
                >
                  <span>ℹ️</span>
                  <span>
                    {t("header.limitedSearchMode") || "Limited search mode"}
                  </span>
                </div>
              </div>
            )}
            ...
            {hasSearchResults ? (
              <>
                ...
                {/* Categories - hidden in Firestore fallback mode */}
                      ...
                      {suggestions.map((suggestion) => (
                        ...
                        >
                          ...
                          <div className="flex-1 text-left">
                            ...
                            >
                              {t("header.price", {
                                amount: suggestion.price.toFixed(2),
                              })}
                            </p>
                          </div>
                        </button>
              ...
              <div className="p-3">
                <div className="flex items-center space-x-2 mb-3">
                  ...
                  <div
                    className={`px-2 py-1 rounded-full ${isDark ? "bg-gray-700" : "bg-gray-100"}`}
                  >
                    <span
