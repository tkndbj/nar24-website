...
const AttributeCard: React.FC<AttributeCardProps> = ({
  ...
  <div
    className="group relative overflow-hidden rounded-md p-1.5 sm:p-2 border transition-all duration-200 bg-white dark:bg-surface border-gray-200 dark:border-gray-700 hover:border-orange-300 dark:hover:border-orange-500"
  >
...
const DynamicAttributesWidget: React.FC<DynamicAttributesWidgetProps> = ({
  ...
  if (isLoading || !product) {
    return (
      <div
        className="rounded-lg p-2 sm:p-3 border bg-white dark:bg-surface border-gray-200 dark:border-gray-700"
      >
        <LoadingSkeleton />
      </div>
    );
