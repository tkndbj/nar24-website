...
export class AllInOneCategoryData {
  ...
  // ------------------------------------------------------
  static readonly kCategoryKeywordToSubcategoryMap: Record<string, Record<string, string>> = {
    'Clothing & Fashion': {
      'dress': 'Dresses',
      'shirt': 'Tops & Shirts',
      'pants': 'Bottoms',
  ...
  static localizeClothingGender(
      rawGender: string, l10n: AppLocalizations): string {
    switch (rawGender) {
      case 'Men':
  ...
  static localizeFootwearGender(gender: string, l10n: AppLocalizations): string {
    switch (gender) {
      case 'Woman':
  ...
  static readonly kBuyerSubSubcategories: Record<string, Record<string, string[]>> = {
    'Women': {
      'Fashion': [
        'Dresses',
        'Tops & Shirts',
    ...
    'Mother & Child': AllInOneCategoryData._getSubSubcategories('Mother & Child'),
    'Home & Furniture': AllInOneCategoryData._getSubSubcategories('Home & Furniture'),
    'Electronics': AllInOneCategoryData._getSubSubcategories('Electronics'),
    'Books, Stationery & Hobby':
        AllInOneCategoryData._getSubSubcategories('Books, Stationery & Hobby'),
    'Sports & Outdoor': AllInOneCategoryData._getSubSubcategories('Sports & Outdoor'),
    'Tools & Hardware': AllInOneCategoryData._getSubSubcategories('Tools & Hardware'),
    ...
    'Health & Wellness': AllInOneCategoryData._getSubSubcategories('Health & Wellness'),
  };
  ...
  static readonly kBuyerToProductCategoryMapping: Record<string, Record<string, string>> = {
    'Women': {
  ...
  static getProductCategoryFromBuyerSelection(
    ...
    return AllInOneCategoryData.kBuyerToProductCategoryMapping[buyerCategory]?.[buyerSubcategory];
  }

  /// Get all relevant product categories for a buyer category
  static getRelevantProductCategories(buyerCategory: string): string[] {
    const mapping = AllInOneCategoryData.kBuyerToProductCategoryMapping[buyerCategory];
  ...
  static filterProductsByBuyerCategory(
    ...
    return products.filter((product) => {
      ...
      if (buyerSubcategory !== undefined) {
        const productCategory = AllInOneCategoryData.getProductCategoryFromBuyerSelection(
          buyerCategory,
          buyerSubcategory,
        );
      ...
      if (buyerCategory === 'Women' || buyerCategory === 'Men') {
        if (!AllInOneCategoryData._isProductSuitableForGender(product, buyerCategory)) {
          return false;
        }
      }
      ...
      if (buyerSubcategory !== undefined && product.subcategory !== undefined) {
        ...
        if (buyerCategory === 'Women' || buyerCategory === 'Men') {
          ...
          if (productCategory !== undefined) {
            ...
            const expectedSubcategories = AllInOneCategoryData.kSubcategories[productCategory] ?? [];
  ...
  static _isProductSuitableForGender(product: Product, gender: string): boolean {
  ...
  static localizeBuyerCategoryKey(rawKey: string, l10n: AppLocalizations): string {
    switch (rawKey) {
      case 'Women':
  ...
  static localizeBuyerSubcategoryKey(
    ...
    switch (parentCategory) {
      ...
      default:
        ...
        return AllInOneCategoryData.localizeSubcategoryKey(parentCategory, rawKey, l10n);
    }
    return rawKey;
  }
      ...
      case 'Men':
        switch (parentSubcategory) {
          case 'Fashion':
            ...
            return AllInOneCategoryData.localizeSubcategoryKey('Clothing & Fashion', rawKey, l10n);
          case 'Shoes':
            // For Shoes, rawKey is actually a subcategory like "Sneakers & Athletic", "Casual Shoes", etc.
            return AllInOneCategoryData.localizeSubcategoryKey('Footwear', rawKey, l10n);
          case 'Accessories':
            // For Accessories, rawKey is actually a subcategory like "Jewelry", "Watches", etc.
            return AllInOneCategoryData.localizeSubcategoryKey('Accessories', rawKey, l10n);
          case 'Bags':
            // For Bags, rawKey is actually a subcategory like "Handbags", "Backpacks", etc.
            return AllInOneCategoryData.localizeSubcategoryKey('Bags & Luggage', rawKey, l10n);
          case 'Self Care':
  ...
  static getCategories(
      forceBuyerCategories: boolean = false): Array<{key: string, image?: string}> {
    if (forceBuyerCategories || AllInOneCategoryData.shouldUseBuyerCategories()) {
  ...
  static getSubcategories(category: string,
      forceBuyerCategories: boolean = false): string[] {
    if (forceBuyerCategories || AllInOneCategoryData.shouldUseBuyerCategories()) {
  ...
  static getSubSubcategories(category: string, subcategory: string,
      forceBuyerCategories: boolean = false): string[] {
    if (forceBuyerCategories || AllInOneCategoryData.shouldUseBuyerCategories()) {
      return AllInOneCategoryData.kBuyerSubSubcategories[category]?.[subcategory] ?? [];
    }
    return AllInOneCategoryData.kSubSubcategories[category]?.[subcategory] ?? [];
  }
  ...
  static getBuyerToProductMapping(
    ...
    const productCategory = buyerSubcategory !== undefined
        ? AllInOneCategoryData.getProductCategoryFromBuyerSelection(buyerCategory, buyerSubcategory)
        : undefined;
